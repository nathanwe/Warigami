...
public:
	...
	{
		r_state.each_id< transforms::transform, components::hit_points, audio::audio_emitter>([&](
			entity_id id1, 
			transforms::transform& transform1, 
			components::hit_points& hp1, 
			audio::audio_emitter& emitter1)
			{
				r_state.each_id< transforms::transform, components::hit_points, audio::audio_emitter>([&](
					entity_id id2, 
